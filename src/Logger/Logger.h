...
#define logI()                                                                                 \
                                                                                               \
  GameServiceManager::getInstance().GetLogService()->Log(ILogService::Level::Info, LOG_FILE(), \
                                                         LOG_LINE(), LOG_FUNCTION())

#define logW()                                                                                 \
                                                                                               \
  GameServiceManager::getInstance().GetLogService()->Log(ILogService::Level::Warn, LOG_FILE(), \
                                                         LOG_LINE(), LOG_FUNCTION())
